...
1. **Review Documentation**
   ...
   - Read [MO:JOURNEY Specification](../mo-journey/specification.md)
   - Read [MO:MIND Specification](../mo-mind/specification.md)
...
- [MO:JOURNEY Specification](../mo-journey/specification.md) - Detailed domain spec
- [MO:MIND Specification](../mo-mind/specification.md) - Detailed agent architecture
